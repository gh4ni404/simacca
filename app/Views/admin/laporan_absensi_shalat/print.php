...
<head>
    ...
    <title>Cetak Laporan Absensi Shalat (Admin)</title>
...
<body>
    ...
    <div class="container">
        ...
        <!-- Judul -->
        <div class="title">
            <h3>LAPORAN REKAPITULASI ABSENSI SHALAT SEKOLAH</h3>
        ...
        <div class="info-table">
            <table>
                ...
                <?php endif; ?>
                <tr>
                    <td>Total Sesi Terbuka</td>
                    <td>:</td>
                    <td><?= $totalSessions ?> Sesi Shalat</td>
                </tr>
                <tr>
                    <td>Tanggal Cetak</td>
                    <td>:</td>
        ...
        <!-- Section 1: Siswa -->
        <?php if (in_array($type, ['siswa', 'semua'])): ?>
            <div class="section-heading"><i class="fas fa-user-graduate"></i> Detail Presensi Kehadiran Siswa Shalat</div>
            <table class="data-table">
                <thead>
                    <tr>
                        <th style="width: 6%;">No</th>
                        <th style="width: 16%;">NIS</th>
                        <th style="width: 36%;">Nama Siswa</th>
                        <th style="width: 16%;">Kelas</th>
                        <th style="width: 13%;">Kehadiran</th>
                        <th style="width: 13%;">Presensi Terakhir</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (!empty($rekapSiswa)): ?>
                        ...
                        <tr>
                            ...
                            <td><strong><?= $row['total_hadir'] ?> kali</strong></td>
                            <td><?= $row['waktu_terakhir'] ? date('d/m/Y H:i', strtotime($row['waktu_terakhir'])) : '-' ?></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="text-align: center; color: #666;">Tidak ada data presensi siswa pada periode ini.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <!-- Section 2: Guru -->
        <?php if (in_array($type, ['guru', 'semua'])): ?>
            <div class="section-heading"><i class="fas fa-chalkboard-teacher"></i> Detail Presensi Kehadiran Guru Shalat</div>
            <table class="data-table">
                <thead>
                    <tr>
                        <th style="width: 6%;">No</th>
                        ...
                        <th style="width: 15%;">Presensi Terakhir</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5" style="text-align: center; color: #666;">Tidak ada data presensi guru pada periode ini.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="signature-section">
            <div class="signature-box">
                <p>Mengetahui,</p>
                <p><strong>Kepala UPT SMKN 8 Bone</strong></p>
            ...
            <div class="signature-box">
                ...
                <p><strong>Administrator / Tim IT</strong></p>
                <div class="signature-space"></div>
