...
<div class="bg-white rounded-xl shadow p-6 mb-6">
    <h2 class="text-lg font-semibold text-gray-800 mb-4">
        <i class="fas fa-school text-indigo-500 mr-2"></i>Ringkasan Per Kelas
    </h2>
...
<div class="bg-white rounded-xl shadow p-6 mb-6">
    <h2 class="text-lg font-semibold text-gray-800 mb-4">
        <i class="fas fa-users text-blue-500 mr-2"></i>Detail Per Siswa
    </h2>
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase">Jumlah Hadir</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
