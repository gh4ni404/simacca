...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?= base_url('admin/absensi-guru/laporan') ?>" class="btn btn-outline-primary">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?= base_url('admin/absensi-guru') ?>">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div>
                            ...
                            <a href="<?= base_url('admin/absensi-guru') ?>" class="btn btn-secondary">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" data-current-page="1">
