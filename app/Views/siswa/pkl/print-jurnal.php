...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: Arial, Helvetica, sans-serif; font-size: 11pt; line-height: 1.4; color: #000; background: white; }
        .container { max-width: 210mm; margin: 0 auto; }
        
        .header { text-align: center; margin-bottom: 20px; border-bottom: 3px double #000; padding-bottom: 8px; }
        .header h1 { font-size: 14pt; font-weight: bold; text-transform: uppercase; margin-bottom: 3px; letter-spacing: 0.5px; }
        ...
        .info-table td.label-cell { width: 180px; }
        .info-table td.separator-cell { width: 15px; text-align: center; }
        
        table.data-table { width: 100%; border-collapse: collapse; margin-bottom: 15px; }
        table.data-table th, table.data-table td { border: 1px solid #000; padding: 8px 10px; text-align: left; font-size: 10pt; }
        table.data-table th { background-color: #f5f5f5; font-weight: bold; text-align: center; text-transform: uppercase; font-size: 9.5pt; }
        table.data-table td.no { text-align: center; width: 40px; }
        table.data-table td.tgl { width: 160px; }
        table.data-table td.catatan { width: 220px; }
        table.data-table td.empty-cell { height: 40px; }
        
        .notes-section { margin-top: 15px; font-size: 9pt; font-style: italic; line-height: 1.5; color: #333; }
        
        .footer-signatures { margin-top: 40px; width: 100%; border-collapse: collapse; page-break-inside: avoid; }
        .footer-signatures td { width: 33.33%; text-align: center; vertical-align: top; padding: 5px; font-size: 11pt; }
    ...
    <table class="footer-signatures" style="display: none;">
        <tr>
            <td>
                ...
                <p class="signature-name"><?= esc($instruktur['nama_lengkap'] ?? '.......................................') ?></p>
            ...
            <td>
                ...
                <p>Pembimbing PKL</p>
                <div class="signature-space"></div>
                <p class="signature-name"><?= esc($pembimbing['nama_guru'] ?? '.......................................') ?></p>
