                ...
                <div class="bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-xl p-5 mb-6 shadow-sm">
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div class="flex gap-2 flex-wrap">
                            ...
                            <button type="button" onclick="setAllStatus('dispen')" class="px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-lg shadow-md transition-all transform hover:scale-105">
                                <i class="fas fa-id-badge mr-1"></i> Semua Dispen
                            </button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td class="px-4 py-4">
                                        ...
                                        <div class="flex gap-1 flex-wrap" data-siswa-id="<?= $sid ?>">
                                            ...
                                            $statusOptionsArr = [
                                                ...
                                                'dispen' => ['label' => 'Dispen', 'icon' => 'fa-id-badge'],
                                            ];
