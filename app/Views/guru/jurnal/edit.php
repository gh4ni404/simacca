    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in-up">
            <div class="flex items-center mb-4">
                <a href="<?= base_url('guru/jurnal/show/' . $jurnal['kelas_id']) ?>" 
        ...
        if (capturedImageBlob) {
            ...
            try {
                ...
                if (response.ok || response.redirected) {
                    ...
                    // Success - redirect to jurnal show (daftar pertemuan)
                    window.location.href = '<?= base_url('guru/jurnal/show/' . $jurnal['kelas_id']) ?>';
                } else {
