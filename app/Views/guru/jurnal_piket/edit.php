            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <?php if (!empty($jurnal['foto_dokumentasi'])): ?>
                        <div id="current_photo_box" class="mb-4 p-3.5 bg-indigo-50/40 rounded-2xl border border-indigo-100 flex items-center gap-4">
                            <img src="<?= base_url('files/jurnal-piket/' . $jurnal['foto_dokumentasi']) ?>" alt="Foto Dokumentasi Saat Ini" class="w-20 h-20 object-cover rounded-xl border border-gray-300 shadow-sm flex-shrink-0">
                            <div class="flex-1">
                                <p class="text-xs font-bold text-gray-800 flex items-center gap-1.5">
                                    <i class="fas fa-check-circle text-emerald-500"></i> Foto Dokumentasi Saat Ini
                                </p>
                                <p class="text-xs text-gray-500 mt-0.5">Unggah foto baru di bawah jika ingin mengganti foto yang lama.</p>
                            </div>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="relative inline-block max-w-sm mx-auto">
                                ...
                                <div class="mt-3 flex items-center justify-center gap-2">
                                    <label for="foto_dokumentasi" class="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-semibold rounded-lg transition border border-indigo-200">
                                        <i class="fas fa-sync-alt"></i> Ganti Foto Lagi
                                    </label>
                                    <button type="button" onclick="cancelPhoto()" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 text-xs font-semibold rounded-lg transition border border-red-200">
                                        <i class="fas fa-trash-alt"></i> Batal Ganti Foto
                                    </button>
                                </div>
                            </div>
                        </div>
