...
<div class="container-fluid px-4">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?= base_url('wakakur/absensi-guru/laporan') ?>" id="filterForm">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div>
                            ...
                            <a href="<?= base_url('wakakur/absensi-guru/laporan') ?>" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnExport').addEventListener('click', function() {
        ...
        window.location.href = '<?= base_url('wakakur/absensi-guru/export-excel') ?>?' + params.toString();
    });
});
</script>
