...
class AbsensiGuruController extends BaseController
{
    ...
    public function laporan()
    {
        ...
        return view('admin/absensi_guru/laporan', $data);
    }
    ...
    public function detail($guruId)
    {
        ...
        if (!$guru) {
            return redirect()->to('/admin/absensi-guru')->with('error', 'Data guru tidak ditemukan');
        }
        ...
        return view('admin/absensi_guru/detail', $data);
    }

    /**
     * Update status absensi (AJAX)
     */
    public function updateStatus()
    {
        ...
        $result = $this->absensiGuruService->updateStatusByAdmin($absensiId, $newStatus, $keterangan);
